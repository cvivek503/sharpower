...
<head>
        ...
        <title>Sharpower | Reset password</title>
                        ...
                        <div class="d-table">
                            <div class="d-table-cell">
                                <div class="login-form">
                                    ...
                                    <p>New to Sharpower? <a href="{{url('register')}}">Sign up</a></p>

                                    <form method="POST" action="{{url('forgot_password_post')}}">
                                        {{ csrf_field() }}
                                        <p>Type in the email you registered with and we will send you a recovery password</p>
                                        ...
                                        <div class="connect-with-social">
                                            <a class="facebook" href="{{url('register')}}"><i class="fa fa-user"></i> Sign up</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
