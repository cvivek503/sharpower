<ul class=navbar-nav>
    ...
    <li class=nav-item>
        <a href="#" @if(Request::segment(1) == "airtime") class="nav-link active" @endif @if(Request::segment(1) == "data") class="nav-link active" @endif class=nav-link>Airtime/Data recharge <i class="fas fa-chevron-down"></i></a> 
        <ul class=dropdown-menu>
           <li class=nav-item><a href="{{url('airtime')}}" @if(Request::segment(1) == "airtime") class="nav-link active" @endif class="nav-link active">Airtime recharge</a></li>
        </ul>
        <ul class=dropdown-menu>
            <li class=nav-item><a href="{{url('data')}}" @if(Request::segment(1) == "data") class="nav-link active" @endif class="nav-link active">Data subscription</a></li>
         </ul>
    </li>
