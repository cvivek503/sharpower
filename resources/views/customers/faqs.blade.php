            ...
            <div class="row">
                <div class="col-lg-5 col-md-12">
                    <div class="faq-content">
                        ...
                        <div class="bar"></div>
                        <p>Here's a list of our frequently asked questions. Kindly go through it to get all answers you might need.</p>

                        <div class="faq-image">
                            <img src="{{asset('public/main/img/faq.png')}}" alt="image">
                        </div>
                    </div>
                </div>
