...
<html lang=zxx>
   ...
   <head>
    ...
    <title>SharpPower Easy Online Electricity Rechage in Nigeria | Smartcard/IUCverify</title>
      ...
      <div class="page-title-area item-bg2 jarallax" data-jarallax='{"speed": 0.3}'>
        <div class="container">
            <div class="page-title-content">
                <h2>Smartcard/IUC verification</h2>
                <p>Verify smartcard/IUC and proceed.</p>
            </div>
        </div>
    </div>
    <!-- End Page Title Area -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="single-pricing-box contact-info" style="min-height: 307px">
                        <ul>
                            <li>
                                <div class="icon">
                            ...
                            <li>
                                ...
                                <a href="#">{{$verify->content->Customer_ID}}</a>
                            </li>
                            <li>
                                <div class="icon">
                        ...
                        <div class="buy-btn float-right" style="margin-top: 60px;">
                            <a href="javascript:void(0)" onclick='openModal()' class="btn btn-primary">Confirm</a>
                        </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-body contact-form">
                    <p id="disco_name"></p>
                    <form class="form-horizontal m-t-30" id="contact-form" method="POST" action="{{url('customers/execute_tv_purchase')}}">
                        {{ csrf_field() }}
                        <input type="hidden" name="serviceID" id="serviceId" value="{{$serviceID}}" />
                        <input type="hidden" name="billersCode" id="billersCode" value="{{$verify->content->Customer_ID}}" />
                        <input type="hidden" name="variation_code" id="variation_code" value="{{$variation_code}}" />
                        ...
                        <div class="form-group">
                            <div class="col-12">
                                <label>Phone</label>
                                <input class="form-control" type="number" @if(Auth::user()!=null) value="{{Auth::user()->phone}}" @endif id="phone" name="phone" required >
                            </div>
                        </div>
