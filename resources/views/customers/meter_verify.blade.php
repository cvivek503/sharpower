                    ...
                    <div class="single-pricing-box contact-info" style="min-height: 307px">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="#">{{$verify->content->Meter_Number}}</a>
                            </li>
                            <li>
                                <div class="icon">
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-body contact-form">
                    <p id="disco_name"></p>
                    <form class="form-horizontal m-t-30" id="contact-form" method="POST" action="{{url('customers/execute_electricity_purchase')}}">
                        {{ csrf_field() }}
                        <input type="hidden" name="serviceID" id="serviceId" value="{{$disco}}" />
                        <input type="hidden" name="billersCode" id="billersCode" value="{{$verify->content->Meter_Number}}" />
                        <input type="hidden" name="variation_code" id="variation_code" value="{{$type}}" />
