                                        ...
                                        {{ csrf_field() }}
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <input type="checkbox" value="Yes" name="view_users" >
                                                </div>
                                                <div class="col-3">
                                                    <label>Manage Admin users</label>
                                                    <input type="checkbox" value="Yes" name="manage_users" >
                                                </div>
                                                <div class="col-3">
                                                    <label>View customers</label>
                                                    <input type="checkbox" value="Yes" name="view_customers" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-3">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <input type="checkbox" value="Yes" name="view_electricity_transactions" >
                                                </div>
                                                <div class="col-3">
                                                    <label>Refund electicity txns</label>
                                                    <input type="checkbox" value="Yes" name="refund_electricity_transactions" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-3">
                                                    <label>View airtime transactions</label>
                                                    <input type="checkbox" value="Yes" name="view_airtime_transactions" >
                                                </div>
                                                <div class="col-3">
                                                    <label>Refund airtime transactions</label>
                                                    <input type="checkbox" value="Yes" name="refund_airtime_transactions" >
                                                </div>
                                                <div class="col-3">
                                                    <label>View data transactions</label>
                                                    <input type="checkbox" value="Yes" name="view_data_transactions" >
                                                </div>
                                                <div class="col-3">
                                                    <label>Refund data transactions</label>
                                                    <input type="checkbox" value="Yes" name="refund_data_transactions" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-3">
                                                    <label>View tv transactions</label>
                                                    <input type="checkbox" value="Yes" name="view_tv_transactions" >
                                                </div>
                                                <div class="col-3">
                                                    <label>Refund tv transactions</label>
                                                    <input type="checkbox" value="Yes" name="refund_tv_transactions" >
                                                </div>
