                    ...
                    <div class="page-title-box">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a href="{{url('admin/new_role')}}" class="btn btn-primary waves-effect waves-light">New role</a>
                            </div>
                        </div>
                        <!-- end row -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title mb-4">Roles</h4>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{url('admin/edit_role/'.$role->id)}}" class="btn btn-primary waves-effect waves-light">Details</a></td>
                                                </tr>
                                                 @endforeach
                                            </tbody>
                                        </table>
